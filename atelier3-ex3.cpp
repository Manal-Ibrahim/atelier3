...
complexe(){
cout<<"entrez la partie reelle de premier nombre : " ; cin>>a;
cout<<"entrez la partie imaginaire de premier nombre : " ; cin>>b;
cout<<"entrez la partie reelle de deuxieme nombre : "; cin>>c;
cout<<"entrez la partie imaginaire de deuxieme nombre : " ; cin>>d;
cout<<endl;
}
float addition(){
...
void egalite(){
if(a==c && b==d){ cout<<" ces nombres complexes sont egaux"<<endl;
